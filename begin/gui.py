...
splash_window = AnimatedSplashWindow(root, "C:/Users/LAPTOP/Desktop/smart music player/build/assets/cover.gif")

def mainWindow():
    root.destroy()
    SginUp = tk.Tk()
    SginUp.title("Smart Music Player")
    SginUp.geometry("1200x800")
